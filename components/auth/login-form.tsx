...
export function LoginForm() {
    ...
    const { signIn, signInWithGoogle, user, initializing } = useAuth()
    ...
    return (
        <Card className="w-full max-w-md mx-auto">
            <CardHeader>
                <CardTitle className="font-serif text-2xl">Bienvenido de vuelta</CardTitle>
                <CardDescription>
                    Inicia sesión para continuar tu viaje en Reflexión.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full" disabled={isLoading || isRedirecting}>
                        {isLoading ? "Ingresando..." : isRedirecting ? "Preparando tu espacio..." : "Iniciar Sesión"}
                    </Button>
                </form>
                ...
                >
                    ...
                    {isRedirecting ? "Preparando tu espacio..." : "Iniciar con Google"}
                </Button>
            </CardContent>
            <CardFooter className="flex justify-center">
                <p className="text-xs text-muted-foreground">
                    ¿No tienes cuenta? <a href="/register" className="underline text-accent">Regístrate</a>
                </p>
            </CardFooter>
        </Card>
    )
